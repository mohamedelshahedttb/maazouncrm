...
<div class="p-6">
    <!-- Page Title -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800">إنشاء موعد جديد</h1>
        <p class="text-gray-600 mt-2">إضافة موعد جديد مع حجز التاريخ والوقت تلقائياً</p>
    </div>

    <div class="max-w-4xl mx-auto">
        <form action="{{ route('appointments.store') }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label for="assigned_to" class="block text-sm font-medium text-gray-700 mb-2">تعيين للموظف/الالشيخ *</label>
            ...
            <div class="flex justify-end space-x-3 space-x-reverse mt-8 pt-6 border-t border-gray-200">
                <a href="{{ route('appointments.index') }}" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50">
                    إلغاء
                </a>
