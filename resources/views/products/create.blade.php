...
<div class="p-6">
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">إضافة منتج جديد مع تحديد السعر والمخزون</p>
    </div>

    <div class="max-w-4xl mx-auto">
        <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            @csrf
            ...
            <div class="flex justify-end space-x-3 space-x-reverse mt-8 pt-6 border-t border-gray-200">
                <a href="{{ route('products.index') }}" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50">
                    إلغاء
                </a>
