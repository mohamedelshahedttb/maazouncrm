...
<div class="p-6">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-800">إضافة مصدر عميل جديد</h1>
        <p class="text-gray-600 mt-2">إضافة مصدر جديد للعملاء</p>
    </div>

    <div class="max-w-2xl mx-auto">
        <form action="{{ route('client-sources.store') }}" method="POST" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            @csrf
            ...
            <div class="flex justify-end space-x-3 space-x-reverse mt-8 pt-6 border-t border-gray-200">
                <a href="{{ route('client-sources.index') }}" class="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50">
                    إلغاء
                </a>
