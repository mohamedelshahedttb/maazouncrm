...
<div class="p-6">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">تحديث بيانات العميل: {{ $client->name }}</p>
    </div>
        ...
        <form method="POST" action="{{ route('clients.update', $client) }}" enctype="multipart/form-data" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="text" name="event_date" id="event_date" value="{{ old('event_date', $client->event_date?->format('d/m/Y')) }}"
                    ...
                    <div>
                        ...
                        <textarea name="bride_id_address" id="bride_id_address" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                  placeholder="أدخل محل إقامة الزوجة">{{ old('bride_id_address', $client->bride_id_address) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" name="mahr" id="mahr" value="{{ old('mahr', $client->mahr) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <select name="governorate_id" id="governorate_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            ...
                            @foreach(\App\Models\Governorate::where('is_active', true)->orderBy('name')->get() as $gov)
                                <option value="{{ $gov->id }}" {{ old('governorate_id', $client->governorate_id) == $gov->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="area_id" id="area_id" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            ...
                            @foreach(\App\Models\Area::where('is_active', true)->orderBy('name')->get() as $area)
                                <option value="{{ $area->id }}" {{ old('area_id', $client->area_id) == $area->id ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <input type="text" name="contract_location" id="contract_location" value="{{ old('contract_location', $client->contract_location) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="number" name="bride_age" id="bride_age" value="{{ old('bride_age', $client->bride_age) }}" min="1" max="100"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <select name="accessories[]" id="accessories" multiple
                            ...
                            @foreach($products as $product)
                                <option value="{{ $product->id }}" data-price="{{ $product->selling_price }}" {{ in_array($product->id, old('accessories', $client->accessories ?? [])) ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <select name="client_status" id="client_status" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            ...
                            <option value="in_progress" {{ old('client_status', $client->client_status) == 'in_progress' ? 'selected' : '' }}>جاري العمل عليه</option>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <select name="discount_type" id="discount_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    ...
                                    <option value="percentage" {{ old('discount_type', $client->discount_type) == 'percentage' ? 'selected' : '' }}>نسبة مئوية</option>
                                    <option value="fixed_amount" {{ old('discount_type', $client->discount_type) == 'fixed_amount' ? 'selected' : '' }}>مبلغ ثابت</option>
                                </select>
                            </div>
                            <div>
                                <input type="number" name="discount_value" id="discount_value" value="{{ old('discount_value', $client->discount_value) }}" step="0.01" min="0"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="groom_name" id="groom_name" value="{{ old('groom_name', $client->groom_name) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <textarea name="contract_address" id="contract_address" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                  placeholder="أدخل عنوان العقد بالتفصيل">{{ old('contract_address', $client->contract_address) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="text" name="temporary_document" id="temporary_document" value="{{ old('temporary_document', $client->temporary_document) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="text" name="sheikh_name" id="sheikh_name" value="{{ old('sheikh_name', $client->sheikh_name) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="text" name="book_number" id="book_number" value="{{ old('book_number', $client->book_number) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="text" name="contract_executor" id="contract_executor" value="{{ old('contract_executor', $client->contract_executor) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="text" name="coupon_arrival_date" id="coupon_arrival_date" value="{{ old('coupon_arrival_date', $client->coupon_arrival_date?->format('d/m/Y')) }}"
                                   class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                   placeholder="dd/mm/yyyy">
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="text" name="document_receipt_date" id="document_receipt_date" value="{{ old('document_receipt_date', $client->document_receipt_date?->format('d/m/Y')) }}"
                                   class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                   placeholder="dd/mm/yyyy">
                    ...
                    <div>
                        ...
                        <select name="document_receiver" id="document_receiver" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            ...
                            <option value="delivery" {{ old('document_receiver', $client->document_receiver) == 'delivery' ? 'selected' : '' }}>دليفري</option>
                            <option value="client" {{ old('document_receiver', $client->document_receiver) == 'client' ? 'selected' : '' }}>العميل</option>
                            <option value="client_relative" {{ old('document_receiver', $client->document_receiver) == 'client_relative' ? 'selected' : '' }}>أحد أقارب العميل</option>
                        </select>
                    ...
                    <div id="delivery_man_field" style="display: none;">
                        ...
                        <input type="text" name="delivery_man_name" id="delivery_man_name" value="{{ old('delivery_man_name', $client->delivery_man_name) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div id="client_relative_field" style="display: none;">
                        ...
                        <input type="text" name="client_relative_name" id="client_relative_name" value="{{ old('client_relative_name', $client->client_relative_name) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div id="client_receiver_field" style="display: none;">
                        ...
                        <input type="text" name="client_receiver_name" id="client_receiver_name" value="{{ old('client_receiver_name', $client->client_receiver_name) }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div class="mt-6">
                ...
                <textarea name="notes" id="notes" rows="4"
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          placeholder="أدخل أي ملاحظات أو تفاصيل إضافية">{{ old('notes', $client->notes) }}</textarea>
                @error('notes')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-right">
                        <input type="hidden" name="final_price" id="final_price" value="{{ old('final_price', $client->final_price) }}">
                        <div id="final_price_display" class="text-2xl font-bold text-blue-900">{{ number_format(old('final_price', $client->final_price), 2) }} جنيه</div>
            ...
            <div class="flex justify-end space-x-4 space-x-reverse mt-8 pt-6 border-t border-gray-200">
                <a href="{{ route('clients.show', $client) }}" class="px-6 py-2 border border-gray-300 text-red-700 rounded-lg hover:bg-gray-50">
                    إلغاء
                </a>
...
document.addEventListener('DOMContentLoaded', function() {
  const dateInputs = ['event_date', 'next_follow_up_date', 'coupon_arrival_date', 'document_receipt_date', 'final_document_delivery_date'];
...
// Trigger initial calculations and UI setup on page load
document.addEventListener('DOMContentLoaded', () => {
    recalcPrice();
    document.getElementById('governorate_id').dispatchEvent(new Event('change'));
});
