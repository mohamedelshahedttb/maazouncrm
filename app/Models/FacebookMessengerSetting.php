...
class FacebookMessengerSetting extends Model
{
    use LogsActivity;
    ...
    public function getDefaultMessageTemplates(): array
    {
        return [
            ...
            'service_inquiry' => 'مرحباً {{client_name}}، شكراً لاستفساركم عن {{service_name}}. سنقوم بالرد عليكم قريباً.',
        ];
    }
    ...
    public function getDefaultAutoReplies(): array
    {
        return [
            ...
            'pricing' => 'أسعار خدماتنا تختلف حسب نوع الخدمة. يمكنكم التواصل معنا للحصول على عرض سعر دقيق.',
            'location' => 'نحن موجودون في {{business_address}}. يمكنكم تحديد موعد لزيارتنا.',
        ];
    }
    ...
    {
        return "https://facebook.com/{$this->page_id}";
    }

    public function getMessengerUrl(): string
    {
        return "https://m.me/{$this->page_id}";
    }
    ...
    public function getActivitylogOptions(): LogOptions
    {
        return LogOptions::defaults()
            ->logOnly(['status', 'page_id', 'page_name', 'is_active'])
            ->logOnlyDirty()
            ->dontSubmitEmptyLogs();
    }
}
